...
/**
 */
public class HeldKarpPathCalculatorTest {

    @Test
    public void test() throws InterruptedException{
        HeldKarpPathCalculator<Point> calculator = new HeldKarpPathCalculator<Point>();
        ...
        assertThat(path.get(1),is(equalTo(new Point(60, 60))));
        assertThat(path.get(2),is(equalTo(new Point(70, 70))));
        assertThat(path.get(3),is(equalTo(new Point(25, 25))));
    }
}
